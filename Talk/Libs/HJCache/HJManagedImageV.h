...
@interface HJManagedImageV : UIView <HJMOUser> {
    ...
    UIViewContentMode contentScaleMode;
    
}
@property UIActivityIndicatorViewStyle loadingStyle;
@property int modification;
@property int index;
@property BOOL keepImageAspectRatio;
@property UIViewContentMode contentScaleMode;
