...
@synthesize index;
@synthesize keepImageAspectRatio;
@synthesize loadingStyle;
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
		...
		onImageTap = nil;
		index = -1;
        keepImageAspectRatio = NO; // For SCG only, should be YES for other projects
        ...
        contentScaleMode=UIViewContentModeScaleAspectFit;
    }
    return self;
}
...
-(void) showLoadingWheel {
	[loadingWheel removeFromSuperview];
	self.loadingWheel = [[[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:loadingStyle] autorelease];
