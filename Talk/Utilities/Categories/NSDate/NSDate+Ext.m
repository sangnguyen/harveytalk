...
// Return format of day
+(NSString*) getDateFormatWithDay:(int)day
{
    NSString *strFormat = @"MMMM dd'th' yyyy";
    switch (day) {
        case 1:
            strFormat = @"MMMM dd'st' yyyy";
            break;
        case 2:
            strFormat = @"MMMM dd'nd' yyyy";
            break;
        case 3:
            strFormat = @"MMMM dd'rd' yyyy";
            break;
        case 21:
            strFormat = @"MMMM dd'st' yyyy";
            break;
        ...
        case 31:
            ...
            break;
        default:
            strFormat = @"MMMM dd'th' yyyy";
            break;
    }
    return strFormat;
}

+(NSString*) getDateTimeFormatWithDay:(int)day
{
    NSString *strFormat = @"MMMM d'th' yyyy HH:mm";
    switch (day) {
        case 1:
            strFormat = @"MMMM d'st' yyyy HH:mm";
            break;
        case 2:
            strFormat = @"MMMM d'nd' yyyy HH:mm";
            break;
        case 3:
            strFormat = @"MMMM d'rd' yyyy HH:mm";
            break;
        case 21:
            strFormat = @"MMMM dd'st' yyyy HH:mm";
            break;
        case 22:
            strFormat = @"MMMM dd'nd' yyyy HH:mm";
            break;
        case 23:
            strFormat = @"MMMM dd'rd' yyyy HH:mm";
            break;
        case 31:
            strFormat = @"MMMM dd'st' yyyy HH:mm";
            break;
        default:{
            if(day<10){
                strFormat = @"MMMM d'th' yyyy HH:mm";
            }else{
                strFormat = @"MMMM dd'th' yyyy HH:mm";
            }
        }break;
    }
    return strFormat;
...
@implementation NSDate (EricSadun)
...
{
    NSInteger subDays = -1 * dDays;
	return [self dateByAddingDays: subDays];
}
...
- (NSString *)shortDate{
    return [NSString stringWithFormat:@"%d/%d/%d",[self day],[self month],[self year_]];
}

- (NSString*) stringWithFormat: (NSString *)format{
    NSDateFormatter *dateFormat = [[NSDateFormatter alloc] init];
    [dateFormat setDateFormat:format];
    return [[dateFormat stringFromDate:self] uppercaseString];
}
