...
+ (MBProgressHUD *)showHUDAddedTo:(UIView *)view animated:(BOOL)animated lockedOtherViews:(BOOL)lockedOtherViews{
    MBProgressHUD *hud = [MBProgressHUD showHUDAddedTo:view animated:animated];
    [hud setUserInteractionEnabled:lockedOtherViews];
    return hud;
}
...
+ (MBProgressHUD *)showHUDAddedTo:(UIView *)view 
    ...
    return [MBProgressHUD showHUDAddedTo:view animated:animated lockedOtherViews:FALSE whileExecutingBlock:block completionBlock:completion];
}

+ (MBProgressHUD *)showHUDAddedTo:(UIView *)view animated:(BOOL)animated 
                 lockedOtherViews:(BOOL)lockedOtherViews
              whileExecutingBlock:(dispatch_block_t)block 
                  completionBlock:(void (^)())completion {
	MBProgressHUD *hud = [[MBProgressHUD alloc] initWithView:view];
	[view addSubview:hud];
    [hud showAnimated:animated whileExecutingBlock:block completionBlock:completion];
	return MB_AUTORELEASE(hud);    
}
...
- (id)initWithView:(UIView *)view lockedOtherViews:(BOOL)lockedOtherViews{
    self = [self initWithView:view];
    [self setUserInteractionEnabled:lockedOtherViews];
    return self;
}
...
- (id)initWithWindow:(UIWindow *)window lockedOtherViews:(BOOL)lockedOtherViews{
